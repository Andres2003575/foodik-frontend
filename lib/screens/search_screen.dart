    ...
    return restaurants.where((r) {
      final matchQuery =
          ...
          (r['name']?.toString().toLowerCase().contains(query.toLowerCase()) ??
              false) ||
          (r['cuisine']?.toString().toLowerCase().contains(
                query.toLowerCase(),
              ) ??
              false);
      return matchQuery;
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: query.isNotEmpty ? primaryColor : Colors.transparent,
            width: 1.5,
          ),
        ),
        child: TextField(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Busca por nombre, cocina o categoría',
